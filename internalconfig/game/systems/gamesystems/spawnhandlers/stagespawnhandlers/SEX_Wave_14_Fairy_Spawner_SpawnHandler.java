...
import static internalconfig.game.components.spawns.StageSpawns.SEX_WAVE_14_FAIRY_SPAWNER;
import static internalconfig.game.systems.gamesystems.spawnhandlers.SpawnUtil.*;

public class SEX_Wave_14_Fairy_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public SEX_Wave_14_Fairy_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(SEX_WAVE_14_FAIRY_SPAWNER, spawnBuilder);
    }
    ...
    public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
        if (tickMod(tick, MOD)) {
            ...
            spawnFairy(sliceBoard, random, new DoublePoint(LEFT_OUT, Y));
        }
    }
    ...
    private void spawnFairy(AbstractPublishSubscribeBoard sliceBoard,
        ...
        sliceBoard.publishMessage(
                spawnBuilder.makeStraightPathCollidable(pos, new PolarVector(SPEED, 0), SMALL_ENEMY_HITBOX, ENEMY_OUTBOUND)
                        .markAsMob(HEALTH)
                        .setAsFairyYellow()
