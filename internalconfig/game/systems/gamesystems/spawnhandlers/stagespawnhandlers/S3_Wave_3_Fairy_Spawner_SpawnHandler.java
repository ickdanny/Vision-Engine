...
public class S3_Wave_3_Fairy_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public S3_Wave_3_Fairy_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.S3_WAVE_3_FAIRY_SPAWNER, spawnBuilder);
    }
    ...
    private double getSpeed(int tick){
        return MIN_SPEED + ((((double)tick) * SPEED_DIFF)/StageSpawns.S3_WAVE_3_FAIRY_SPAWNER.getDuration());
    }
