...
public class S3_Wave_9_Fairy_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    private static final double MIN_X = WIDTH * .65;
    private static final double MAX_X = WIDTH - 30;
    private static final double X_DIFF = MAX_X - MIN_X;

    private static final double FINAL_ANGLE_LOW = -48 - 90;
    private static final double FINAL_ANGLE_HIGH = -42 - 90;
    ...
    public S3_Wave_9_Fairy_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.S3_WAVE_9_FAIRY_SPAWNER, spawnBuilder);
    }
    ...
    private double getSpeed(int tick){
        return MIN_SPEED + ((((double)tick) * SPEED_DIFF)/StageSpawns.S3_WAVE_9_FAIRY_SPAWNER.getDuration());
    }
    ...
    private InstructionNode<?, ?>[] makeProgram(Random random) {
        return ProgramUtil.makeShootOnceAndLeaveEnemyProgram(
                ...
                SLOW_DURATION,
                PRE_TIMER,
                DanmakuSpawns.S3_WAVE_7_FAIRY_RINGS,
