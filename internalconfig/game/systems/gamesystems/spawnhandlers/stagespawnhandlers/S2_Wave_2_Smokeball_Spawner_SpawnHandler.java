...
public class S2_Wave_2_Smokeball_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public S2_Wave_2_Smokeball_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.S2_WAVE_2_SMOKEBALL_SPAWNER, spawnBuilder);
    }
