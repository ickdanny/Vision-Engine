...
public class SEX_Wave_1_Fairy_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public SEX_Wave_1_Fairy_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.SEX_WAVE_1_FAIRY_SPAWNER, spawnBuilder);
    }
    ...
    private void spawnFairy(AbstractPublishSubscribeBoard sliceBoard,
        ...
        sliceBoard.publishMessage(
                spawnBuilder.makeStraightPathCollidable(pos, new PolarVector(SPEED, -90), SMALL_ENEMY_HITBOX, ENEMY_OUTBOUND)
                        ...
                        .setProgram(makeProgram(random, new Angle(180)))
                        .packageAsMessage()
        );
    }
