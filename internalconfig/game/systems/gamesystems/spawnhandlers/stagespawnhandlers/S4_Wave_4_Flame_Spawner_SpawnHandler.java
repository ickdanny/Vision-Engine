...
public class S4_Wave_4_Flame_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public S4_Wave_4_Flame_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.S4_WAVE_4_FLAME_SPAWNER, spawnBuilder);
    }
    ...
    public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
        if (tickMod(tick, MOD)) {
            ...
            spawnFlame(sliceBoard, random, new DoublePoint(RIGHT_OUT, Y));
        }
    }
    ...
    private void spawnFlame(AbstractPublishSubscribeBoard sliceBoard,
        ...
        sliceBoard.publishMessage(
                spawnBuilder.makeStraightPathCollidable(pos, new PolarVector(SPEED, 180), SMALL_ENEMY_HITBOX, ENEMY_OUTBOUND)
                        ...
                        .setProgram(makeProgram(random, new Angle((double) 180 - 90)))
                        .packageAsMessage()
        );
    }
