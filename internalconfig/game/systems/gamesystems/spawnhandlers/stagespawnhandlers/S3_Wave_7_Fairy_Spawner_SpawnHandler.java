...
public class S3_Wave_7_Fairy_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public S3_Wave_7_Fairy_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.S3_WAVE_7_FAIRY_SPAWNER, spawnBuilder);
    }
    ...
    private double getSpeed(int tick){
        return MIN_SPEED + ((((double)tick) * SPEED_DIFF)/StageSpawns.S3_WAVE_7_FAIRY_SPAWNER.getDuration());
    }
