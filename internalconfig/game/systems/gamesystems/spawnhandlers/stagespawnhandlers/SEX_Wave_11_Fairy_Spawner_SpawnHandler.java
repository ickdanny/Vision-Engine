...
import static internalconfig.game.components.spawns.StageSpawns.SEX_WAVE_11_FAIRY_SPAWNER;
import static internalconfig.game.systems.gamesystems.spawnhandlers.SpawnUtil.*;

public class SEX_Wave_11_Fairy_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {

    private static final int MOD = SEX_WAVE_11_FAIRY_SPAWNER.getDuration() / 8;
    ...
    public SEX_Wave_11_Fairy_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(SEX_WAVE_11_FAIRY_SPAWNER, spawnBuilder);
    }
    ...
    public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
        if (tickMod(tick, MOD)) {
            ...
            SpawnUtil.staggeredBlockFormation(
                    tick,
                    SEX_WAVE_11_FAIRY_SPAWNER.getDuration(),
                    MOD,
