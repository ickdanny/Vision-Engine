...
public class S4_Wave_1_Flame_Spawner_SpawnHandler extends AbstractSpawnHandlerTemplate {
    ...
    public S4_Wave_1_Flame_Spawner_SpawnHandler(SpawnBuilder spawnBuilder) {
        super(StageSpawns.S4_WAVE_1_FLAME_SPAWNER, spawnBuilder);
    }
    ...
    public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
        if (tickMod(tick, MOD)) {
            ...
            spawnFlame(sliceBoard, random, new DoublePoint(LEFT_OUT, Y), 0, 37);
