...
public class LongBulletClearSpawnHandler extends AbstractSpawnHandlerTemplate {

    private static final int LIFETIME = 115;
    private static final InstructionNode<?, ?>[] PROGRAM = ProgramUtil.makeLifetimeProgram(LIFETIME).compile();

    public LongBulletClearSpawnHandler(SpawnBuilder spawnBuilder) {
        super(OtherGameSpawns.LONG_BULLET_CLEAR, spawnBuilder);
    }
