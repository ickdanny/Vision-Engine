...
public class SpecialHighExplodeSpawnHandler extends AbstractPositionVelocitySpawnHandler {

    public SpecialHighExplodeSpawnHandler(SpawnBuilder spawnBuilder, AbstractComponentTypeContainer componentTypeContainer) {
        super(GraphicSpawns.SPECIAL_HIGH_EXPLODE, spawnBuilder, componentTypeContainer);
    }
        ...
        sliceBoard.publishMessage(
                spawnBuilder.makeVisibleGameObject(pos)
                        ...
                        .setAnimation(new AnimationComponent(
                                new Animation(false,
                                        "special_high_explode_1",
                                        "special_high_explode_2"
                                )
                        ))
                        .setSpriteInstruction(new SpriteInstruction("special_high_explode_1"))
