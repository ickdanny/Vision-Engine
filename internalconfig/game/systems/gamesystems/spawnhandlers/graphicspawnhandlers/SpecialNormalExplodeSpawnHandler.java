...
public class SpecialNormalExplodeSpawnHandler extends AbstractPositionVelocitySpawnHandler {

    public SpecialNormalExplodeSpawnHandler(SpawnBuilder spawnBuilder, AbstractComponentTypeContainer componentTypeContainer) {
        super(GraphicSpawns.SPECIAL_NORMAL_EXPLODE, spawnBuilder, componentTypeContainer);
    }
        ...
        sliceBoard.publishMessage(
                spawnBuilder.makeVisibleGameObject(pos)
                        ...
                        .setAnimation(new AnimationComponent(
                                new Animation(false,
                                        "special_normal_explode_1",
                                        "special_normal_explode_2"
                                )
                        ))
                        .setSpriteInstruction(new SpriteInstruction("special_normal_explode_1"))
