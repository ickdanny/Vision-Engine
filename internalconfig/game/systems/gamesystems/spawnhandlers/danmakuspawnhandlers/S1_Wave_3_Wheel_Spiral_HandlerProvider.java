...
import static internalconfig.game.components.spawns.DanmakuSpawns.S1_WAVE_3_WHEEL_SPIRAL;

import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;

public class S1_Wave_3_Wheel_Spiral_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public S1_Wave_3_Wheel_Spiral_HandlerProvider(SpawnBuilder spawnBuilder, AbstractComponentTypeContainer componentTypeContainer) {
        super(spawnBuilder, componentTypeContainer);
    }

    //SHOULD BE SAME AS WAVE 9
    ...
    private class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(int mod,
            ...
            super(S1_WAVE_3_WHEEL_SPIRAL, spawnBuilder, componentTypeContainer);
            this.mod = mod;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, mod)) {
                ...
                SpawnUtil.spiralFormation(tick, S1_WAVE_3_WHEEL_SPIRAL.getDuration(), baseAngle, angularVelocity, (angle) ->
