...
public class B4_Pattern_5_2_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public B4_Pattern_5_2_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(int mod1,
            ...
            super(B4_PATTERN_5_2, spawnBuilder, componentTypeContainer);
            this.mod1 = mod1;
            this.mod2 = mod2;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            ...
            if (spawn1 || spawn2) {
                ...
                if(spawn2) {
                    SpawnUtil.sineFormation(tick, baseAngle2, SINE_TICK_MULTI, SINE_ANGLE_BOUND, (sineAngle) -> {
