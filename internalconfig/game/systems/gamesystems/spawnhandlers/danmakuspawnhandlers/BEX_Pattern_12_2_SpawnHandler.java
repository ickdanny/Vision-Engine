...
import static internalconfig.game.components.spawns.DanmakuSpawns.BEX_PATTERN_12_2;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class BEX_Pattern_12_2_SpawnHandler extends AbstractPositionSpawnHandler {

    private static final int SPIRAL_FORMATION_MAX_TICK = 13;

    private static final double ANGULAR_VELOCITY = 360d/BEX_PATTERN_12_2.getDuration();

    private static final double SPEED = 1.6;

    public BEX_Pattern_12_2_SpawnHandler(SpawnBuilder spawnBuilder,
                                         AbstractComponentTypeContainer componentTypeContainer) {
        super(BEX_PATTERN_12_2, spawnBuilder, componentTypeContainer);
    }
