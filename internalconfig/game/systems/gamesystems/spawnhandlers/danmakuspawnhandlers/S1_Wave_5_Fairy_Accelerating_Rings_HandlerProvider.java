...
import static internalconfig.game.components.spawns.DanmakuSpawns.S1_WAVE_5_FAIRY_ACCELERATING_RINGS;

import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;

public class S1_Wave_5_Fairy_Accelerating_Rings_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public S1_Wave_5_Fairy_Accelerating_Rings_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    private class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(double speedLow,
            ...
            super(S1_WAVE_5_FAIRY_ACCELERATING_RINGS, spawnBuilder, componentTypeContainer);
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, S1_WAVE_5_FAIRY_ACCELERATING_RINGS.getDuration() / 4)) {
