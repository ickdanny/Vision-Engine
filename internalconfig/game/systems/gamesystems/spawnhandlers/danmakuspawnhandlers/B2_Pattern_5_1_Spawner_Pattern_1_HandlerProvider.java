...
import static internalconfig.game.components.spawns.DanmakuSpawns.B2_PATTERN_5_1_SPAWNER_PATTERN_1;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class B2_Pattern_5_1_Spawner_Pattern_1_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public B2_Pattern_5_1_Spawner_Pattern_1_HandlerProvider(SpawnBuilder spawnBuilder, AbstractComponentTypeContainer componentTypeContainer) {
    ...
    private class Template extends AbstractPositionVelocitySpawnHandler{
        ...
        private Template(int mod, int symmetry, double angularVelocity, double speed, SpawnBuilder spawnBuilder) {
            super(B2_PATTERN_5_1_SPAWNER_PATTERN_1, spawnBuilder, componentTypeContainer);
            this.mod = mod;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, mod)) {
                ...
                SpawnUtil.spiralFormation(tick, B2_PATTERN_5_1_SPAWNER_PATTERN_1.getDuration(), baseAngle, angularVelocity, (angle) -> {
        ...
        private void spawnBullet(DoublePoint pos, AbstractVector velocity, AbstractPublishSubscribeBoard sliceBoard) {
            sliceBoard.publishMessage(
                    spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, MEDIUM, CYAN, -200, -10)
