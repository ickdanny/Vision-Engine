...
import static internalconfig.game.components.spawns.DanmakuSpawns.S4_WAVE_10_APPARITION_PATTERN_2;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class S4_Wave_10_Apparition_Pattern_2_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public S4_Wave_10_Apparition_Pattern_2_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private static final double BASE_ANGLE = 5;
        ...
        private Template(int mod,
            ...
            super(S4_WAVE_10_APPARITION_PATTERN_2, spawnBuilder, componentTypeContainer);
            this.mod = mod;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, mod)) {
                ...
                SpawnUtil.spiralFormation(tick, S4_WAVE_10_APPARITION_PATTERN_2.getDuration(), BASE_ANGLE, turnAngularVelocity, (spiralAngle) -> {
