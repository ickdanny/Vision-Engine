...
import static internalconfig.game.components.spawns.DanmakuSpawns.S3_WAVE_7_FAIRY_RINGS;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.ROSE;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.MEDIUM;

public class S3_Wave_7_Fairy_Rings_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    private static final int MOD = S3_WAVE_7_FAIRY_RINGS.getDuration() / 2;

    public S3_Wave_7_Fairy_Rings_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    private class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(int symmetry,
            ...
            super(S3_WAVE_7_FAIRY_RINGS, spawnBuilder, componentTypeContainer);
