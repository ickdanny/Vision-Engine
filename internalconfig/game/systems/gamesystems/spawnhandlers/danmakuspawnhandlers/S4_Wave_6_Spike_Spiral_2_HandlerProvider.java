...
import static internalconfig.game.components.spawns.DanmakuSpawns.S4_WAVE_6_SPIKE_SPIRAL_2;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class S4_Wave_6_Spike_Spiral_2_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public S4_Wave_6_Spike_Spiral_2_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(int mod,
            ...
            super(S4_WAVE_6_SPIKE_SPIRAL_2, spawnBuilder, componentTypeContainer);
            this.mod = mod;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, mod)) {
                ...
                SpawnUtil.spiralFormation(tick, S4_WAVE_6_SPIKE_SPIRAL_2.getDuration(), baseAngle, angularVelocity,
        ...
        private void spawnBullet(DoublePoint pos, AbstractVector velocity, AbstractPublishSubscribeBoard sliceBoard) {
            sliceBoard.publishMessage(
                    spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, SMALL, RED, NORMAL_OUTBOUND, 0)
