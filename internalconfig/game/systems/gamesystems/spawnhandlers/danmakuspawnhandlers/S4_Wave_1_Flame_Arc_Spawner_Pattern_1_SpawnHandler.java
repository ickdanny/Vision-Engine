...
public class S4_Wave_1_Flame_Arc_Spawner_Pattern_1_SpawnHandler extends AbstractPositionVelocitySpawnHandler {

    private static final double ANGLE_OFFSET = 31;
    private static final double SPEED = 3.5;

    public S4_Wave_1_Flame_Arc_Spawner_Pattern_1_SpawnHandler(SpawnBuilder spawnBuilder,
                                                              AbstractComponentTypeContainer componentTypeContainer) {
        super(DanmakuSpawns.S4_WAVE_1_FLAME_ARC_SPAWNER_PATTERN_1, spawnBuilder, componentTypeContainer);
    }
    ...
    public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
        ...
        spawnBullet(pos, new PolarVector(SPEED, spawnerAngle), sliceBoard);
    ...
    private void spawnBullet(DoublePoint pos, AbstractVector velocity, AbstractPublishSubscribeBoard sliceBoard) {
        sliceBoard.publishMessage(
                spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, SHARP, ORANGE, NORMAL_OUTBOUND, 5)
