...
import static internalconfig.game.components.spawns.DanmakuSpawns.MBEX_PATTERN_1_1;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class MBEX_Pattern_1_1_SpawnHandler extends AbstractPositionSpawnHandler {

    private static final double SPEED = 6;

    private static final int MOD = 2;

    private static final double ANGLE_INCREMENT = 12;

    private static final int MAX_SYMMETRY = MBEX_PATTERN_1_1.getDuration()/MOD;

    public MBEX_Pattern_1_1_SpawnHandler(SpawnBuilder spawnBuilder,
                                               AbstractComponentTypeContainer componentTypeContainer) {
        super(MBEX_PATTERN_1_1, spawnBuilder, componentTypeContainer);
    }
