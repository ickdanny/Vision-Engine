...
import static internalconfig.game.components.spawns.DanmakuSpawns.BEX_PATTERN_11_1;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class BEX_Pattern_11_1_SpawnHandler extends AbstractPositionSpawnHandler {
    ...
    private static final double ANGULAR_VELOCITY = .6 * .5;

    private static final double SPEED_LOW = 1.1;
    private static final double SPEED_HIGH = 5.66;
    ...
    public BEX_Pattern_11_1_SpawnHandler(SpawnBuilder spawnBuilder,
                                        AbstractComponentTypeContainer componentTypeContainer) {
        super(BEX_PATTERN_11_1, spawnBuilder, componentTypeContainer);
    }
