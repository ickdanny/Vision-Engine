...
import static internalconfig.game.components.spawns.DanmakuSpawns.B4_PATTERN_3_1;
import static internalconfig.game.components.spawns.DanmakuSpawns.B4_PATTERN_3_2;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class B4_Pattern_3_1_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public B4_Pattern_3_1_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private final int SPIRAL_FORMATION_TICK = B4_PATTERN_3_2.getDuration();
        ...
        private Template(int mod,
            ...
            super(B4_PATTERN_3_1, spawnBuilder, componentTypeContainer);
            this.mod = mod;
