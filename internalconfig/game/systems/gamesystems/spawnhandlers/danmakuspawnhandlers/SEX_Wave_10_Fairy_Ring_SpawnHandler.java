...
public class SEX_Wave_10_Fairy_Ring_SpawnHandler extends AbstractPositionSpawnHandler {

    private static final int SYMMETRY = 30;
    private static final int ROWS = 2;

    private static final double SPEED_LOW = 2.5;
    private static final double SPEED_HIGH = 3.23;

    public SEX_Wave_10_Fairy_Ring_SpawnHandler(SpawnBuilder spawnBuilder,
                                              AbstractComponentTypeContainer componentTypeContainer) {
        super(SEX_WAVE_10_FAIRY_RING, spawnBuilder, componentTypeContainer);
    }
