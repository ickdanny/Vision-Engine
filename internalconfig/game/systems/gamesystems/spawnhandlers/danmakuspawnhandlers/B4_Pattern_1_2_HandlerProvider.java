...
public class B4_Pattern_1_2_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public B4_Pattern_1_2_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(int mod,
            ...
            super(B4_PATTERN_1_2, spawnBuilder, componentTypeContainer);
            this.mod = mod;
