...
import static internalconfig.game.components.spawns.DanmakuSpawns.SEX_WAVE_8_SMOKEBALL_SPIRAL;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class SEX_Wave_8_Smokeball_Spiral_SpawnHandler extends AbstractPositionSpawnHandler {
    ...
    public SEX_Wave_8_Smokeball_Spiral_SpawnHandler(SpawnBuilder spawnBuilder,
                                                    AbstractComponentTypeContainer componentTypeContainer) {
        super(SEX_WAVE_8_SMOKEBALL_SPIRAL, spawnBuilder, componentTypeContainer);
    }
    ...
    public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
        if (tickMod(tick, MOD)) {
            ...
            SpawnUtil.spiralFormation(tick, SEX_WAVE_8_SMOKEBALL_SPIRAL.getDuration(), baseAngle, ANGULAR_VELOCITY, (spiralAngle) -> {
    ...
    private void spawnSharpBullet(DoublePoint pos, AbstractVector velocity, AbstractPublishSubscribeBoard sliceBoard) {
        sliceBoard.publishMessage(
                spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, SHARP, CYAN, NORMAL_OUTBOUND, 10)
