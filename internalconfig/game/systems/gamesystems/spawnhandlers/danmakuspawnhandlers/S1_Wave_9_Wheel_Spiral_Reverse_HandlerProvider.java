...
import static internalconfig.game.components.spawns.DanmakuSpawns.S1_WAVE_9_WHEEL_SPIRAL_REVERSE;

import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;

public class S1_Wave_9_Wheel_Spiral_Reverse_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public S1_Wave_9_Wheel_Spiral_Reverse_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private Template(int mod,
            ...
            super(S1_WAVE_9_WHEEL_SPIRAL_REVERSE, spawnBuilder, componentTypeContainer);
            this.mod = mod;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, mod)) {
                ...
                SpawnUtil.spiralFormation(tick, S1_WAVE_9_WHEEL_SPIRAL_REVERSE.getDuration(), baseAngle, angularVelocity,
                        (angle) -> SpawnUtil.columnFormation(speedLow, speedHigh, rows, (speed) -> {

                            AbstractVector baseVelocity = new PolarVector(speed, angle);
                            SpawnUtil.ringFormation(pos, baseVelocity, spiralSymmetry, (ringPos, ringVelocity) -> {
        ...
        private void spawnBullet(DoublePoint pos, AbstractVector velocity, AbstractPublishSubscribeBoard sliceBoard) {
            sliceBoard.publishMessage(
                    spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, MEDIUM, MAGENTA, NORMAL_OUTBOUND, -1)
