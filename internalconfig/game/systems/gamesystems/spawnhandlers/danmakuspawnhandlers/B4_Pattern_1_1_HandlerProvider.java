...
import static internalconfig.game.components.spawns.DanmakuSpawns.B4_PATTERN_1_1;
import static internalconfig.game.components.spawns.DanmakuSpawns.B4_PATTERN_1_2;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class B4_Pattern_1_1_HandlerProvider extends AbstractDifficultyDependentSpawnHandlerProvider {

    public B4_Pattern_1_1_HandlerProvider(SpawnBuilder spawnBuilder,
    ...
    protected class Template extends AbstractPositionSpawnHandler {
        ...
        private final int SPIRAL_FORMATION_TICK = B4_PATTERN_1_2.getDuration();
        ...
        private Template(int mod,
            ...
            super(B4_PATTERN_1_1, spawnBuilder, componentTypeContainer);
            this.mod = mod;
        ...
        public void handleSpawn(AbstractECSInterface ecsInterface, int tick, int entityID) {
            if (tickMod(tick, mod)) {
                ...
                SpawnUtil.spiralFormation(SPIRAL_FORMATION_TICK, SPIRAL_FORMATION_MAX_TICK, baseAngle1, angularVelocity1, (spiralAngle) -> {
                ...
                SpawnUtil.spiralFormation(SPIRAL_FORMATION_TICK, SPIRAL_FORMATION_MAX_TICK, baseAngle2, angularVelocity2, (spiralAngle) -> {
        ...
        private void spawnBullet2(DoublePoint pos,
            ...
            sliceBoard.publishMessage(
                    spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, SHARP, CYAN, -100, 1)
