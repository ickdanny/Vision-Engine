...
import static internalconfig.game.components.spawns.DanmakuSpawns.BEX_PATTERN_1_1;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileColors.*;
import static internalconfig.game.systems.gamesystems.spawnhandlers.EnemyProjectileTypes.*;

public class BEX_Pattern_1_1_SpawnHandler extends AbstractPositionSpawnHandler {
    ...
    private static final double ANGULAR_VELOCITY = -.6;
    ...
    public BEX_Pattern_1_1_SpawnHandler(SpawnBuilder spawnBuilder,
                                         AbstractComponentTypeContainer componentTypeContainer) {
        super(BEX_PATTERN_1_1, spawnBuilder, componentTypeContainer);
    }
