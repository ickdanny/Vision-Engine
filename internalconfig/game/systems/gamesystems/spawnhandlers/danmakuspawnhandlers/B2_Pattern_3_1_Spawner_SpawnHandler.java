...
public class B2_Pattern_3_1_Spawner_SpawnHandler extends AbstractPositionSpawnHandler {

    private static final double INIT_SPEED = 2;
    private static final int WAIT_TIME = 100;
    private static final int SLOW_TIME = WAIT_TIME - 2;

    private static final InstructionNode<?, ?>[] PROGRAM_1 =
            ProgramBuilder.linearLink(
                    ...
                    ProgramBuilder.linearLink(
                            ...
                            ProgramBuilder.linearLink(
                                    ...
                                    REMOVE_VISIBLE,
                                    new InstructionNode<>(SET_SPAWN, DanmakuSpawns.B2_PATTERN_3_1_SPAWNER_PATTERN_1),
    ...
    private static final InstructionNode<?, ?>[] PROGRAM_2 =
            ProgramBuilder.linearLink(
                    new InstructionNode<>(TIMER, ENEMY_BULLET_COLLIDABLE_TIME),
                    SET_COLLIDABLE
            ).linkInject(
                    ProgramBuilder.linearLink(
                            ...
                            ProgramBuilder.linearLink(
                                    new InstructionNode<>(TIMER, WAIT_TIME),
                                    REMOVE_VISIBLE,
                                    new InstructionNode<>(SET_SPAWN, DanmakuSpawns.B2_PATTERN_3_1_SPAWNER_PATTERN_2),
                                    WAIT_UNTIL_SPAWN_COMPONENT_EMPTY,
                                    REMOVE_ENTITY
                            )
                    )
    ...
    public B2_Pattern_3_1_Spawner_SpawnHandler(SpawnBuilder spawnBuilder, AbstractComponentTypeContainer componentTypeContainer) {
        super(DanmakuSpawns.B2_PATTERN_3_1_SPAWNER, spawnBuilder, componentTypeContainer);
    }
    ...
    private void spawnSpawner1(AbstractPublishSubscribeBoard sliceBoard, DoublePoint pos, AbstractVector velocity) {
        sliceBoard.publishMessage(
                spawnBuilder.makeStraightSlowableEnemyBullet(pos, velocity, MEDIUM, MAGENTA, -200, 0)
