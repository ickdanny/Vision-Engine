...
class ClearFieldInstructionHandler implements AbstractInstructionHandler<Void, Void>{

    private final AbstractComponentType<SpawnComponent> spawnComponentType;

    ClearFieldInstructionHandler(AbstractComponentTypeContainer componentTypeContainer){
    ...
    public Instructions<Void, Void> getInstruction() {
        return Instructions.CLEAR_FIELD;
    }
    ...
    public boolean handleInstruction(AbstractECSInterface ecsInterface,
        ...
        spawnComponent.addSpawnUnit(OtherGameSpawns.MEDIUM_BULLET_CLEAR);
        return true;
    }
}
