...
import static internalconfig.game.components.Instructions.WAIT_UNTIL_PLAYER_FOCUSED;

class WaitUntilPlayerFocusedInstructionHandler implements AbstractInstructionHandler<Void, Void> {

    @Override
    public Instructions<Void, Void> getInstruction() {
        return WAIT_UNTIL_PLAYER_FOCUSED;
    }
