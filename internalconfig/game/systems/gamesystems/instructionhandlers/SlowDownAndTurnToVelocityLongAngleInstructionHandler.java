...
import static internalconfig.game.components.Instructions.SLOW_DOWN_AND_TURN_TO_VELOCITY_LONG_ANGLE;

class SlowDownAndTurnToVelocityLongAngleInstructionHandler extends AbstractSlowDownAndTurnToVelocityInstructionHandler {
    SlowDownAndTurnToVelocityLongAngleInstructionHandler(AbstractComponentTypeContainer componentTypeContainer) {
    ...
    protected Tuple2<Double, Double> retrieveOrCreateVelocityIncrement(InstructionDataMap dataMap,
        ...
        if (dataMap.containsKey(node)) {
            ...
            double speedIncrement = ticks > 1
                    ...
                    : speedDifference;
            double angleDifference = finalAngle.largerDifference(oldAngle);
    ...
    public Instructions<Tuple2<AbstractVector, Integer>, Tuple2<Double, Double>> getInstruction() {
        return SLOW_DOWN_AND_TURN_TO_VELOCITY_LONG_ANGLE;
    }
}