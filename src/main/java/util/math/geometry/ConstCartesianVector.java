...
public class ConstCartesianVector extends AbstractCartesianVectorTemplate{

    public ConstCartesianVector(){
        super();
    }

    public ConstCartesianVector(double x, double y) {
        super(x, y);
    }

    public ConstCartesianVector(AbstractVector toCopy) {
        super(toCopy);
    }
